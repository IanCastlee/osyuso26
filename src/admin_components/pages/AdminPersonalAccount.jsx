...
function AdminPersonalAccount() {
  ...
  const { data, loading, refetch } = useGetData("admin/get-my-account.php");

  const account = useMemo(() => data?.data || data || {}, [data]);
  const user = account?.user || {};
  const stats = account?.stats || {};

  const { submit, loading: saving } = useFormSubmit("admin/update-profile.php");
        ...
        <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          <div className="bg-secondary px-5 py-6 text-white sm:px-6">
            ...
            <p className="mt-1 text-sm text-white/80">
              Manage your admin identity. Platform pricing and contact settings
              stay in Admin Settings.
            </p>
          </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
              ...
              <div className="grid content-start gap-4 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2 rounded-2xl border border-orange-100 bg-orange-50 p-4 text-sm text-orange-800">
                  This page updates your personal admin profile only. Use Admin
                  Settings for platform commission, promotion rate, and support
                  contact details.
                </div>
